    ...
    <div className="fixed bottom-0 left-0 right-0 h-[90px] bg-black/50 backdrop-blur-[40px] border-t border-white/10 grid grid-cols-[1fr_2fr_1fr] items-center px-4 gap-4 z-[1000] max-lg:grid-cols-[1fr_1.5fr_0.5fr] max-md:h-auto max-md:grid-cols-1 max-md:py-3 max-md:gap-3">
      ...
      <div className="flex flex-col gap-2 items-center">
        <div className="flex items-center gap-2">
          ...
          <button 
            className="bg-transparent border-none text-white/80 cursor-pointer p-2 flex items-center justify-center rounded-full transition-all duration-200 hover:text-white hover:bg-white/10" 
            onClick={onPrevious} 
            aria-label="Previous"
          >
            <SkipBack size={20} />
          ...
          <button 
            className="w-10 h-10 bg-white text-black border-none cursor-pointer rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110" 
            onClick={onPlayPause} 
        ...
        <div className="flex items-center gap-3 w-full max-w-[600px]">
          ...
          <div className="relative flex-1 h-1.5 bg-white/10 rounded-sm overflow-hidden group">
            <div
      ...
      <div className="flex items-center justify-end gap-3 max-md:hidden">
        ...
        <div className="relative w-[100px] h-1.5 bg-white/10 rounded-sm overflow-hidden max-lg:w-[60px] group">
          <div
